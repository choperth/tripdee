...
export const SPONSORS: Sponsor[] = [
  {
    ...
    category: 'activity',
    categoryLabel: 'กิจกรรมท่องเที่ยวเชิงจริยธรรม',
    ...
    badgeText: 'ปางช้างเชิงจริยธรรม แม่แตง',
    image: '/images/rantong-sanctuary.jpg',
    link: 'https://www.rantongelephantsanctuary.com/',
    discountText: 'กิจกรรมดูแลช้าง ป้อนอาหาร และอาบน้ำช้างในลำธารธรรมชาติ',
  ...
  {
    id: 'sp-7',
    title: 'The Connect Chiang Mai (เดอะ คอนเน็ค เชียงใหม่)',
    category: 'hotel',
  ...
  {
    id: 'sp-8',
    title: 'บ้านทิพย์ - พูลวิลล่าริมน้ำสวยงาม (Baan Thip Villa)',
    category: 'hotel',
    categoryLabel: 'พูลวิลล่าริมน้ำ',
    tagline: 'วิลล่าพักผ่อนริมน้ำ 4 ห้องนอน สระว่ายน้ำส่วนตัวและสวนสีเขียวขนาดใหญ่ ออกแบบโดยสถาปนิก เหมาะสำหรับครอบครัวและกลุ่มเพื่อน',
    badgeText: 'พูลวิลล่าริมน้ำ เชียงใหม่ ★4.85',
    image: '/images/baan-thip-villa.jpg',
    link: 'https://th.airbnb.com/rooms/32648518',
    discountText: 'วิลล่าทั้งหลัง 4 ห้องนอน 4 เตียง สระว่ายน้ำส่วนตัวริมน้ำปิง',
    location: 'ริมแม่น้ำ อ.เมืองเชียงใหม่ จ.เชียงใหม่',
    region: 'north',
    targetAudience: 'traveler',
  },
  {
    id: 'sp-9',
    title: 'บ้านศรีธา - บ้านไม้ที่มีเสน่ห์ในเมือง (Baan Sri Dha)',
    category: 'hotel',
    categoryLabel: 'บ้านพักไม้ทรงเสน่ห์',
    tagline: 'บ้านกึ่งไม้ทั้งหลัง 5 ห้องนอน รองรับ 9 คน ใกล้ประตูเชียงใหม่และถนนคนเดินวัวลาย พร้อมอาหารเช้าโฮมเมดและบริการรถรับส่งฟรี',
    badgeText: 'ที่พักติดอันดับท็อป 1% ★4.94',
    image: '/images/baan-sri-dha.jpg',
    link: 'https://th.airbnb.com/rooms/9056914',
    discountText: 'บ้านทั้งหลัง 5 ห้องนอน 5 เตียง ฟรีอาหารเช้าและรถรับส่งสนามบิน',
    location: 'ต.หายยา อ.เมืองเชียงใหม่ (ใกล้ประตูเชียงใหม่ & ถนนคนเดินวัวลาย)',
    region: 'north',
    targetAudience: 'traveler',
  },
  {
    id: 'sp-10',
    title: 'อพาร์ทเมนท์ล้านนา - ที่พัก 5 ห้องนอนกว้างขวางกลางเมืองเชียงใหม่ (Lanna Apartment)',
    category: 'hotel',
    categoryLabel: 'ที่พัก 5 ห้องนอนในเมือง',
    tagline: 'ชั้น 1 ของอาคารส่วนตัวทั้งชั้น ห้องนอน 5 ห้อง ห้องน้ำในตัวทุกห้อง เครื่องปรับอากาศทุกห้อง ห้องนั่งเล่นล้อมรอบ 3 ห้อง และลานกลางแจ้ง เหมาะกับครอบครัวและกลุ่มเพื่อนที่รองรับได้ถึง 10 คน',
    badgeText: 'ที่พักติดอันดับท็อป 10% ★4.96',
    image: '/images/lanna-riverside-home.jpg',
    link: 'https://th.airbnb.com/rooms/957661325183385971',
    discountText: 'รถรับส่งสนามบินฟรี · อาหารเช้าเสริม · Wi-Fi ใยแก้วนำแสง 287 Mbps · ที่จอดรถฟรี',
    location: 'ต.หายยา อ.เมืองเชียงใหม่ (เดิน 6 นาทีถึงตลาดประตูเชียงใหม่)',
    region: 'north',
    targetAudience: 'traveler',
  },
  {
    id: 'sp-11',
    title: 'บ้านศรีธา - บ้านสไตล์ล้านนาและโยคะ (Baan Sri Dha Lanna & Yoga)',
    category: 'hotel',
    categoryLabel: 'บ้านพักสไตล์ล้านนา & โยคะ',
    tagline: 'บ้านเดี่ยวไม้สักสไตล์ล้านนา 3 ห้องนอน 3 ห้องน้ำ รองรับ 5 คน พื้นที่สีเขียวและลานโยคะส่วนตัว ใกล้ตลาดประตูเชียงใหม่ พร้อมอาหารเช้าโฮมเมดและบริการรถรับส่งสนามบินฟรี',
    badgeText: 'โดนใจเกสต์ ★4.96 (477 รีวิว)',
    image: '/images/baan-sri-dha-yoga.jpg',
