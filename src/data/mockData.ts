...
export const SPONSORS: Sponsor[] = [
  {
    ...
    badgeText: 'ที่พักยอดนิยม ม่อนแจ่ม',
    image: 'https://images.unsplash.com/photo-1582719478250-c89cae4dc85b?auto=format&fit=crop&w=800&q=80',
    link: 'https://www.facebook.com',
    discountText: 'วิวทะเลหมอก 360 องศา พร้อมสระว่ายน้ำส่วนตัว',
  ...
  },
  {
    ...
    categoryLabel: 'บริการดูแลรักษารถ',
    tagline: 'บริการตรวจเช็กระบบเบรก ถ่ายน้ำมันเครื่อง เปลี่ยนยางสำหรับรถตู้และรถบริการ',
    badgeText: 'ศูนย์บริการมาตรฐาน',
    image: 'https://images.unsplash.com/photo-1619642751034-765dfdf7c58e?auto=format&fit=crop&w=800&q=80',
    link: 'tel:0899999999',
    discountText: 'ตรวจเช็กความพร้อมระบบเบรกและช่วงล่างก่อนเดินทาง',
  ...
  {
    id: 'sp-3',
    title: 'ทิพยประกันภัย ประกันภัยการเดินทาง & รถเช่า',
    category: 'insurance',
    categoryLabel: 'ประกันภัยการเดินทาง',
    tagline: 'เดินทางอุ่นใจไร้กังวล คุ้มครองทั้งคนขับ ผู้โดยสาร และความเสียหายตัวรถตลอด 24 ชม.',
    badgeText: 'ประกันภัยการเดินทาง',
    image: 'https://images.unsplash.com/photo-1450133064473-71024230f91b?auto=format&fit=crop&w=800&q=80',
    link: 'https://www.dhipaya.co.th',
    discountText: 'แผนประกันภัยเดินทางคุ้มครองอุบัติเหตุและค่ารักษาพยาบาล',
  ...
  {
    id: 'sp-4',
    title: 'PT Station & กาแฟพันธุ์ไทย',
    category: 'fuel',
    categoryLabel: 'สถานีบริการน้ำมัน & พักรถ',
    tagline: 'จุดแวะพักเติมน้ำมัน พักคนขับ และเครื่องดื่มกาแฟพันธุ์ไทยตลอดเส้นทางทั่วไทย',
    badgeText: 'จุดแวะพักการเดินทาง',
    image: 'https://images.unsplash.com/photo-1545454675-3531b543be5d?auto=format&fit=crop&w=800&q=80',
    link: 'https://www.pt.co.th',
    discountText: 'สถานีบริการน้ำมันคุณภาพและจุดพักผ่อนระหว่างทาง',
