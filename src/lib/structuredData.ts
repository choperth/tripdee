...
export function getStructuredData() {
  ...
  const websiteSchema = {
    ...
    url: BASE_URL,
    name: 'TripDee ทริปดี',
    description: 'ทริปดีๆ เริ่มต้นที่นี่ รวมรถตู้พร้อมคนขับ เชียงใหม่ และที่พักคุณภาพ',
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        '@type': 'Question',
        name: 'เช่ารถตู้พร้อมคนขับในเชียงใหม่ผ่าน TripDee คิดราคาอย่างไร?',
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'ราคากลางมาตรฐานรถตู้พร้อมคนขับในเชียงใหม่เริ่มต้นที่ประมาณ 1,800 - 2,000 บาท/วัน สำหรับเส้นทางในเมือง/รอบเมือง/สนามบิน, 2,000 - 2,300 บาท/วัน สำหรับดอยระดับกลาง (ม่อนแจ่ม แม่ริม แม่กำปอง), และ 2,300 - 2,600 บาท/วัน สำหรับดอยสูง (ดอยอินทนนท์ อ่างขาง) โดยลูกค้าติดต่อตกลงและโทรหาคนขับตรงโดยไม่บวกค่านายหน้า',
        },
      },
      {
        '@type': 'Question',
